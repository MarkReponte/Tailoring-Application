...
{
    partial class ComputationHistoryPopup
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            panel1.Name = "panel1";
            panel1.Size = new Size(818, 65);
            panel1.TabIndex = 1;
            // 
            // btnViewCostConsumption
            // 
            btnViewCostConsumption.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
            btnViewCostConsumption.BorderColor = Color.FromArgb(220, 223, 230);
            btnViewCostConsumption.ButtonType = ReaLTaiizor.Util.HopeButtonType.Primary;
            btnViewCostConsumption.DangerColor = Color.FromArgb(245, 108, 108);
            btnViewCostConsumption.DefaultColor = Color.FromArgb(255, 255, 255);
            ...
            btnViewCostConsumption.SuccessColor = Color.FromArgb(103, 194, 58);
            btnViewCostConsumption.TabIndex = 160;
            btnViewCostConsumption.Text = "X";
            btnViewCostConsumption.TextColor = Color.White;
            btnViewCostConsumption.WarningColor = Color.FromArgb(230, 162, 60);
            btnViewCostConsumption.Click += btnViewCostConsumption_Click;
            // 
            // btnViewOrders
            // 
            ...
            lblOrderHistory.Size = new Size(147, 19);
            lblOrderHistory.TabIndex = 6;
            lblOrderHistory.Text = "Computation History";
            // 
            // ComputationHistoryPopup
            // 
